...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <br><br><br>
<center side="font_title">  <font color="blue" > 字典详细信息</font>
...
<form id="form1" name="form1" method="post" action="${pageContext.request.contextPath}/dict/updateDictionary.do">
    <input  type="hidden" id="id" name="id" value="${dictionary.id}"/>
  <tr>
    <td width="30%" align="right" bgcolor="#FFFFFF">数据字典代码：</td>
    
    <td width="70%"  bgcolor="#FFFFFF">
      <input size="50" type="text" name="code" id="code"  value="${ dictionary.code}" disabled="disabled"/>
      <span id="result"> </span>
    </td>
  ...
  <tr>
    ...
    <td width="70%"  bgcolor="#FFFFFF">
      <input size="50" type="text" name="key" id="key" value="${ dictionary.key}" />
      <span id="result"> </span>
    </td>
  ...
  <tr>
    ...
    <td width="70%"  bgcolor="#FFFFFF">
      <input size="50" type="text" name="value" id="value"  value="${dictionary.value }"/>
      <span id="result"> </span>
    </td>
  </tr>
  ...
  <tr>
    ...
    <td bgcolor="#FFFFFF"> <textarea rows="4" cols="40" id="description" name="description">${dictionary.description }</textarea> </td>
  </tr>
