...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <br><br><br>
<center side="font_title">  <font color="blue" > 请假单信息</font>
...
<form id="form1" name="form1" method="post" action="${pageContext.request.contextPath}/leaveBill/updateLeaveBill.do">
...
<legend>流程审批</legend>
    ...
    <input type="button" name="but1" id="but1" value="提交" /> &nbsp;&nbsp;&nbsp;&nbsp;
	       ...
	       function  (){
	    	  ...
	    	  var msg = "任务将要提交！！！\n请确认！";
	    		if (confirm(msg)==true){
	    		 ...
	    		 if(flag){
	    			 var url = "${pageContext.request.contextPath}/leaveBill/submitLeaveBillTaskCaoGao.do";  
	    			 //更改form的action  
