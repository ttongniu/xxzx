...
$(function(){
    ...
    $("#sbutton").click(function(){
    	 ...
    	 $.ajax({  
    		    type: "POST",  
    		    url:"${pageContext.request.contextPath}/group/addGroup.do",  
    		    dataType: "text",
...
<body>
	...
	<center side="font_title">
		<font color="blue">角色组添加</font>
		<hr align="center" width="600" size="1" noshade="noshade"
			color="#336699" />
	</center>
<form id="form1">
<table  width="60%" align="center" class="data_table" cellpadding="0" cellspacing="0">
         <tr>
          <td align="right" class="data_table_title">数据名称：</td>
          <td class="data_table_content">
          	<input name="groupName" type="text" id="groupName" class="data_table_content"></td>
        </tr>
        <tr>
          <td align="right" class="data_table_title">数据描述：</td>
          <td class="data_table_content">
          	<textarea name="groupDesc" id="groupDesc"></textarea></td>
        </tr>
      </table>
          <br>
          <div align="center">
