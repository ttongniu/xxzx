...
<table class="main_table" cellpadding="0" cellspacing="0" align="center">
  <tr  valign="top">
    <td width="100%"><table class="data_table" width="100%" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td class="data_table_content" width="80%">
        <input type="hidden" name="parentId" value="${menu.parentId }"/></td>
      </tr>
      <tr>
        <td class="data_table_title">菜单名称：</td>
        <td class="data_table_content">
		<input name="menuName" id="menuName" type="text" class="data_table_content"></td>
      </tr>
      <tr>
        <td class="data_table_title">url：</td>
        <td class="data_table_content">
		<input name="url" id="url" type="text" class="data_table_content"></td>
      </tr>
	  <tr>
        <td class="data_table_title">是否启用：</td>
        <td class="data_table_content"><input name="flag" type="checkbox" class="data_table_content" id="viewable" value="1" ></td>
      </tr>     
    </table>
      <table width="100%" cellpadding="0" cellspacing="0">
        ...
        <tr>
		  ...
		  <input type="button" id="sbutton" name="sbutton" value="添加下级节点"/>
