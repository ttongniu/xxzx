...
<body>
	<form id="form1">
		...
		<table width="100%" align="center" class="data_table" cellpadding="0"
			cellspacing="0">
			<tr>
				...
				<td class="data_table_content"><input name="employeeId"
					...
					value="${user.employeeId }" onblur="idCheck()" disabled="disabled"><span
					id="idSpan"></span></td>
				</td>
			</tr>
			<tr>
				...
				<td class="data_table_content"><input name="employeeName"
					...
					value="${user.employeeName }" onblur="nameCheck()"><span
					id="nameSpan"></span></td>
				</td>
			</tr>
			<tr>
				...
				<td class="data_table_content"><input type="text" name="email"
					id="email" class="data_table_content" value="${user.email }"
					onblur="emailCheck()" disabled="disabled"><span id="emailSpan"></span></td>
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td class="data_table_content"><select name="depNum"
					id="depNum" class="data_table_content" onchange="deptCheck()">
						<option value="${user.depNum }" selected>
							${user.department.depName }</option>
