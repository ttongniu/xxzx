    ...
    <c:when test="${ not empty  taskInstances }">
         <c:forEach items="${taskInstances }"  var="taskInstance" varStatus="status">
		  <tr bgcolor="#FFFFFF"> 
		    ...
		    <td class="data_table_content_left" width="20%"><div align="center">【${taskInstance.step }】   （${taskInstance.stateUser }）</div></td>
		    ...
		    <div align="center">
			    ...
			    <a   target="_blank"  href="${pageContext.request.contextPath }/wf/viewHisCurrentImage.do?taskId=${taskInstance.id }"> <img alt="查看当前流程图"  title="查看当前流程图" src="${pageContext.request.contextPath}/images/viewDiagram.png" width="25" height="25" ></a>
		    </div>
		    </td>
		  </tr>
         </c:forEach>
...
<script type="text/javascript">
		$("#id").change(function(){
			//alert("***");
			 document.forms['form1'].action="${pageContext.request.contextPath}/wf/listunFinishedHaveTODO.do";
